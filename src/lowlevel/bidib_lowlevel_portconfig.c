...
void bidib_send_lc_output(t_bidib_node_address node_address, unsigned char port0,
	...
	unsigned char data[] = {port0, port1, portstat};
...
void bidib_send_lc_port_query(t_bidib_node_address node_address, unsigned char port0,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {port0, port1};
...
void bidib_send_lc_port_query_all(t_bidib_node_address node_address,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {query_params.select0, query_params.select1,
...
void bidib_send_lc_configx_set(t_bidib_node_address node_address, unsigned char port0,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data_length = (unsigned char) 2 + (pairs_num * (unsigned char) 2);
...
void bidib_send_lc_configx_get_all(t_bidib_node_address node_address, unsigned char port0,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {port0, port1, address_range.start0, address_range.start1,
...
void bidib_send_lc_macro_handle(t_bidib_node_address node_address, unsigned char macro_index,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {macro_index, opcode};
...
void bidib_send_lc_macro_set(t_bidib_node_address node_address,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {macro_params.data0, macro_params.data1, macro_params.data2,
...
void bidib_send_lc_macro_get(t_bidib_node_address node_address, unsigned char macro_index,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {macro_index, point_index};
...
void bidib_send_lc_macro_para_get(t_bidib_node_address node_address, unsigned char macro_index,
	...
	unsigned char addr_stack[] = {node_address.top, node_address.sub,
	                              node_address.subsub, 0x00};
	unsigned char data[] = {macro_index, param_index};
