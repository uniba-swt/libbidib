...
const char *const bidib_cs_state_string_mapping[9] = {
	"BIDIB_CS_STATE_OFF",                                   // 0
	"BIDIB_CS_STATE_STOP",                                  // 1
	"BIDIB_CS_STATE_SOFTSTOP",                              // 2
	"BIDIB_CS_STATE_GO",                                    // 3
	"BIDIB_CS_STATE_GO_IGN_WD",                             // 4
	"BIDIB_CS_STATE_PROG",                                  // 5
	"BIDIB_CS_STATE_PROGBUSY",                              // 6
	"BIDIB_CS_STATE_BUSY",                                  // 7
	"BIDIB_CS_STATE_QUERY"                                  // 8
};

const char *const bidib_boost_state_string_mapping[0x85] = {
